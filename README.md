...
make -j$(($(nproc) + 1)) V=s
```
`rm -rf lede/ && git clone https://github.com/coolsnowwolf/lede && cd lede && sed '$a\src-git kenzo https://github.com/kenzok8/openwrt-packages' feeds.conf.default && sed '$a\src-git small https://github.com/kenzok8/small' feeds.conf.default && ./scripts/feeds update -a && ./scripts/feeds install -a && make menuconfig`
